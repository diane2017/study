...
<head>
<meta charset="UTF-8">
<title>新闻视界用户注册</title>
<link rel="stylesheet" href="/new2/public/css/reset.css"/>
<link type="text/css" rel="stylesheet" href="/new2/public/css/login.css"/>
</head>
<body>
<!-- 注册模块开始 -->
<div class="content" id="main">
	<header class="content-tit"><h1>欢迎注册新闻视界</h1></header>
	...
	<div class="mainBody">
		...
		<div id="regMain" class="regForm" style="display: block;">
			<dl id="nameDl" class="regForm-item mainBody-hasFocus-focusArea">
				...
				<dd class="regForm-item-ct">
					<input onfocus="HGW(this);" onblur="SGW(this);" id="nameIpt" name="name" type="text" class="ipt" style="ime-mode:disabled;color:#999;font-weight:normal" autocomplete="off" value="">
			...
			<dl id="mainMobileDl" class="regForm-item">
				...
				<dd class="regForm-item-ct">
					...
					<div class="itl" style="width:35px;height:27px;line-height:27px;"><div class="itlFlag flag-CN"><em>&nbsp;</em></div></div></div>
					<div id="mainMobileTips" class="tips">
						<span class="txt-tips">忘记密码时，可以通过该手机号码快速找回密码</span>
					</div>
				</dd>
			</dl>
			<dl id="vcodeDl" class="regForm-item vCodeArea vCodeArea-big">
				<dt class="regForm-item-tit"><span class="txt-impt">*</span>验证码</dt>
				<dd class="regForm-item-ct">
					<input id="vcodeIpt" name="vcode" type="text" class="ipt" autocomplete="off" style="width: 196px;">
					<img id="vcodeImg" class="vCode" style="cursor:pointer;" src="/unireg/call.do?cmd=register.verifyCode&amp;v=common/verifycode/vc_en&amp;vt=main_acode&amp;env=681086624789&amp;t=1499569422690" alt="验证码" width="120" height="50"><a id="vcodeA" href="javascript:void(0);" class="switchvCode" tabindex="-1">看不清楚？换张图片</a>
					<div id="vcodeTips" class="tips">
						<span class="txt-tips" id="vRemind">请填写图片中的字符，不区分大小写</span>
					</div>
					
					<div class="btns">
						<a id="sendMainAcodeBtn" href="javascript:void(0);" class="btn" hidefocus="true" onclick="_Global.main.mainAcode();">
							<strong id="sendMainAcodeStg">免费获取验证码</strong></a>
						<span id="acodeMainSentSpan" class="txt-succ" style="display:none;">&nbsp;&nbsp;短信验证码已发送</span>
					</div>
				</dd>
			</dl>
			
			<dl id="acodeMainDl" class="regForm-item">
				<dt class="regForm-item-tit"><span class="txt-impt">*</span>短信验证码</dt>
				<dd class="regForm-item-ct">
					<input id="mainAcodeIpt" name="acode" type="text" class="ipt norWidthIpt" autocomplete="off">
					<div id="mainAcodeTips" class="tips">
		...
		<div id="regMobile" class="regForm" style="display: none;">
			...
			<dl id="mVcodeDl" class="regForm-item vCodeArea vCodeArea-big">
				<dt class="regForm-item-tit"><span class="txt-impt">*</span>图片验证码</dt>
				<dd class="regForm-item-ct">
					<input id="mVcodeIpt" name="vcode" type="text" class="ipt" autocomplete="off" style="width: 196px;">
					<img id="mVcodeImg" class="vCode" style="cursor:pointer;" src="/unireg/call.do?cmd=register.verifyCode&amp;v=common/verifycode/vc_en&amp;vt=mobile_acode&amp;t=1499569422700" alt="验证码" width="120" height="50"><a id="mVcodeA" href="javascript:void(0);" class="switchvCode" tabindex="-1">看不清楚？换张图片</a>
					<div id="mVcodeTips" class="tips">
						<span class="txt-tips" id="mVRemind">请填写图片中的字符，不区分大小写</span>
					</div>
					<div class="btns">
			...
			<dl id="mobileAcceptDl" class="regForm-item">
				<dd class="regForm-item-ct txt-tips">
					<label></label><input id="mobileAcceptIpt" type="checkbox" checked="checked" tabindex="-1"> 同意<a href="javascript:void(0);" onclick="noticePopup.show();return false;" tabindex="-1">"用户须知"</a>和<a href="http://reg.163.com/agreement_game.shtml" target="_blank" tabindex="-1">"隐私权相关政策"</a>
		...
		<div id="regVipFrame" class="regVipFrame" style="padding-left: 0px; width: 640px; height: 620px; margin-left: -58px; display: none;"><iframe id="regVipFrameId" src="http://vip.163.com/reg/vip_reg.html#from=fmail_reg_tab&amp;domain=163&amp;type=30" frameborder="0" border="0" width="100%" height="100%" style="width:100%;height:100%;"></iframe></div>
	</div>
	</div>
</div>
<!-- 注册模块结束 -->
