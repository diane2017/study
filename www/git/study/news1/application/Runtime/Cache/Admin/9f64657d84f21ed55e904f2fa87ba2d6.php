...
<!-- ueditor编辑器 -->
<script type="text/javascript" charset="utf-8" src="/news1/library/ueditor/ueditor.config.js"></script>
<script type="text/javascript" charset="utf-8" src="/news1/library/ueditor/ueditor.all.min.js"></script>
<script type="text/javascript" charset="utf-8" src="/news1/library/ueditor/lang/zh-cn/zh-cn.js"></script>
</head>
<body>
...
<script>
	...
	<div id="admin-main">
		<div id="admin-main-wrapper">
			<div class="current-position">当前位置：<a href="/news1/admin.php/Index/menu">首页</a>&nbsp;&gt;&nbsp;发布新闻</div>
			<form action="/news1/admin.php/Article/insert" method="post">
				<table>
					<tr>
						<td class="col-title">新闻标题</td>
						<td><input type="text" name="art_subject" class="art_subject"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<select name="ptr_id">
								<?php if(is_array($ptr_row)): foreach($ptr_row as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["ptr_name"]); ?></option><?php endforeach; endif; ?>					
							</select>
					...
					<tr>
						...
						<td><script id="editor" name="art_content" type="text/plain" style="width:100%;height:350px;"></script></td>
					</tr>					
					<tr>
						<td>&nbsp;</td>
